...
class Base():
    ...
    def polyline_correction(self, value):
        ...
        # new_pt_list=list(n_pl.ToPolyline() )

        # print(len(new_pt_list))
        new_pts=self._pt_distance_mapping(pts, new_pt_list)

        # print("[DEBUG] - Base.polyline_correction - ori pts: {}".format(self.pts[0] ) )
        ...
        # print("[DEBUG] - Base.polyline_correction - moved pts: {}".format(self.pts[0] ) )
