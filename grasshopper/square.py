from complex_pt_handling import Simple, optimal_rec
from baking import bake
import Rhino.Geometry as rg

class Square:
    def __init__(self, pts, correction, side_interlock, split_idx = 0, mesh_correction = False, extra_folds = False):
        self.datastructure = Simple(pts, split_idx)
